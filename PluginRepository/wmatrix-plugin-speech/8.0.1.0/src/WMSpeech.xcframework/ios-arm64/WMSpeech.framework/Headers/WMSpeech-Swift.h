...
#ifndef WMSPEECH_SWIFT_H
#define WMSPEECH_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="WMSpeech",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8WMSpeech13SpeechManager")
...
@interface SpeechManager (SWIFT_EXTENSION(WMSpeech)) <AVSpeechSynthesizerDelegate>
