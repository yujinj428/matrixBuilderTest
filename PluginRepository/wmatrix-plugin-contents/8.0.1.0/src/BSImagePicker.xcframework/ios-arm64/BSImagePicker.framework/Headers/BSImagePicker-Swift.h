...
SWIFT_CLASS("_TtC13BSImagePicker26BSGridCollectionViewLayout")
@interface BSGridCollectionViewLayout : UICollectionViewLayout
- (void)prepareLayout;
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC13BSImagePicker11BSImageView")
...
@interface BSImageView (SWIFT_EXTENSION(BSImagePicker))
