...
SWIFT_CLASS("_TtC13WMatrixMobile15CallBackManager")
@interface CallBackManager : NSObject
@property (nonatomic, readonly, strong) id <CommandDelegate> _Nullable commandDelegate;
@property (nonatomic, readonly, strong) WMatrixCommand * _Nonnull command;
- (void)successWithData:(id _Nullable)data keepCallback:(BOOL)keepCallback;
...
@property (nonatomic, readonly, strong) WMatrixWebView * _Nullable webView;
...
@property (nonatomic, readonly, strong) WMatrixWebView * _Nullable webView;
- (void)setWWebView:(WMatrixWebView * _Nonnull)webView;
- (void)dispose;
@optional
...
/// \param command nil
///
- (void)checkRefreshUpdate:(CallBackManager * _Nonnull)manager;
/// 서버선택화면 출력
/// \param command nil
///
- (void)showServerSelect:(CallBackManager * _Nonnull)manager;
/// WMatrix 초기화
- (void)reset:(CallBackManager * _Nonnull)manager;
/// network connection check
/// \param command nil
///
- (void)isOffline:(CallBackManager * _Nonnull)manager;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
@property (nonatomic, readonly, strong) WMatrixWebView * _Nullable webView;
@property (nonatomic, readonly, weak) NSObject <CommandDelegate> * _Nullable commandDelegate;
@property (nonatomic, strong) UIViewController * _Nullable viewController;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (void)setWWebView:(WMatrixWebView * _Nonnull)webView;
- (void)setCommand:(NSObject <CommandDelegate> * _Nullable)delegate;
- (void)dispose;
- (void)pluginInitialize;
- (void)handleOpenURL:(NSNotification * _Nonnull)notification;
- (void)handleOpenURLWithApplicationSourceAndAnnotation:(NSNotification * _Nonnull)notification;
...
///   </li>
/// </ul>
- (void)logLevel:(CallBackManager * _Nonnull)manager;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
@interface ServerSelectView : UIView
...
@interface ServerSelectView (SWIFT_EXTENSION(WMatrixMobile)) <UITableViewDelegate>
...
@interface ServerSelectView (SWIFT_EXTENSION(WMatrixMobile)) <UITableViewDataSource>
...
+ (void)dismissScrean;
+ (void)loadJS:(NSArray<NSString *> * _Nonnull)params;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
